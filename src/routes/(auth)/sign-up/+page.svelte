<script>
    import google from '$lib/logos/google.png';
    import apple from '$lib/logos/apple.png';
    import facebook from '$lib/logos/facebook.png';
</script>

<main class="w-full flex">
	<div class="relative flex-1 hidden items-center justify-center h-screen bg-gray-900 lg:flex">
		<div class="relative z-10 w-full max-w-md">
			<img src="https://floatui.com/logo-dark.svg" width="150" alt="Logo WeConnect" />
			<div class="mt-16 space-y-3">
				<h3 class="text-white text-3xl font-bold">Start growing your business quickly</h3>
	...
	<div class="flex-1 flex items-center justify-center h-screen">
		<div class="w-full max-w-md space-y-8 px-4 bg-white text-gray-600 sm:px-0">
			<div class="flex flex-col text-center items-center">
				...
				<div class="mt-5 space-y-2">
					...
					<p class="">
						...
						<a href="log-in" class="font-medium text-indigo-600 hover:text-indigo-500"
							>Log in</a
						>
					</p>
				</div>
			...
			<div class="grid grid-cols-3 gap-x-3">
				...
				>
					<img src={google} alt="Google" class="w-6" />
				</button>
				<button
					class="flex items-center justify-center py-2.5 border rounded-lg hover:bg-gray-50 duration-150 active:bg-gray-100"
					aria-label="Logo in with Apple"
				>
					<img src={apple} alt="Apple" class="w-6" />
				</button>
				<button
					class="flex items-center justify-center py-2.5 border rounded-lg hover:bg-gray-50 duration-150 active:bg-gray-100"
					aria-label="Logo in with Facebook"
				>
